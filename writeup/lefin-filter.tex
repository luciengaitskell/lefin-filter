...
corresponding to over roughly $40$\,Mbit of weights once quantized to \texttt{int8}.
...
\begin{enumerate}
    ...
    \item 0 cycles to go through full-connected
...
an additional latency of around $50 ns$.
