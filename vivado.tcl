...
#
# Generated by Vivado on Sat Nov 29 22:54:27 EST 2025
...
#
#    "/home/lucg/work/lefin-filter/vivado/vivado.srcs/constrs_1/new/constraints.xdc"
#    "/home/lucg/work/lefin-filter/vivado/vivado.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"
#
# 3. The following remote source files that were added to the original project:-
#
#    "/home/lucg/work/lefin-filter/bd/design_1/design_1.bd"
#    "/home/lucg/work/lefin-filter/bd/design_1/hdl/design_1_wrapper.v"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/vivado/vivado.srcs/constrs_1/new/constraints.xdc"]"\
 "[file normalize "$origin_dir/vivado/vivado.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"]"\
  ]
  foreach ifile $files {
 ...
 "[file normalize "$origin_dir/bd/design_1/hdl/design_1_wrapper.v"]"\
  ...
  set paths [list \
 "[file normalize "$origin_dir/[file normalize "$origin_dir/ip_repo/model_demo_1_0"]"]"\
  ]
  foreach ipath $paths {
...
set_property -name "webtalk.xcelium_export_sim" -value "19" -objects $obj
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/ip_repo/model_demo_1_0"]" $obj
...
set file "$origin_dir/bd/design_1/hdl/design_1_wrapper.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set file "[file normalize "$origin_dir/vivado/vivado.srcs/constrs_1/new/constraints.xdc"]"
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xczu48dr-ffvg1517-2-e -flow {Vivado Synthesis 2025} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xczu48dr-ffvg1517-2-e -flow {Vivado Implementation 2025} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
