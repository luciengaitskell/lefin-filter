...
package model_params;
  ...
  localparam signed [WEIGHT_BIT_WIDTH-1:0] FC_WEIGHT[0:FC_OUT_DIM-1][0:FC_IN_DIM-1] = '{
      '{17, -123, -50, -43},
      '{-127, -47, 70, -4}
  };
  ...
  localparam signed [WEIGHT_BIT_WIDTH-1:0] CONV1D_1_WEIGHT [0:CONV1D_1_CHANNEL_OUT_COUNT-1][0:CONV1D_1_CHANNEL_IN_COUNT-1][0:CONV1D_1_KERNEL_WIDTH-1] = '{
      '{
          '{
              -14,
              -39,
      ...
      '{'{-19, 2, 1, -3, 4, 3, 0, 0, 3, -55, 9, -38, 2, 7, -2, -4, 1, 1, -2, 1, 3, -1, 3, 2, -13}},
      '{
          '{
              -74,
              0,
  ...
  localparam signed [WEIGHT_BIT_WIDTH-1:0] CONV1D_1_BIAS[0:CONV1D_1_CHANNEL_OUT_COUNT-1] = '{
      36,
      -127,
      -70,
      -83
